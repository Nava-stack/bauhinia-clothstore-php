...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>BAUHINIA - Clothing Store</title>
    ...
    <div class="container-fluid bg-secondary text-dark mt-5 pt-5">
      <div class="row px-xl-5 pt-5">
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
          ...
          <p class="mb-2">
            <i class="fa fa-map-marker-alt text-primary mr-3"></i>123 Trinco road,
            Batticaloa, Srilanka
          </p>
          <p class="mb-2">
            <i class="fa fa-envelope text-primary mr-3"></i>bauhinia@gmail.com
          </p>
          <p class="mb-0">
            <i class="fa fa-phone-alt text-primary mr-3"></i>+94 3456 67893
          </p>
        </div>
